#!/bin/bash
# Run:AI entrypoint for E44 (FlowAlign on LTX-Video + spectral phase op).
...
python e44_ltx_flowalign.py --part smoke --steps 12 --frames 25 --size 256
...
OUT = os.path.join(os.path.dirname(os.path.abspath("e44_ltx_flowalign.py")), "results", "e44")
...
PY
echo "[job] STAGE0 done -- smoke videos + shape dump in experiments/results/e44/"
